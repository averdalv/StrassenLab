...
public class Strassen implements AM{
    static String file1, file2;

    public static void main(String[] args) {
		if (args.length<2 ) { 
			System.out.println("Usage: Strassen file1 file2"); 
			return;
		}
		file1 = args[0];
		file2 = args[1];
	...
	System.out.println("\nResult found!. Saving to file Strassen.res");
	Res.Save(info.curtask.addPath("Strassen.res"));
	}
}
